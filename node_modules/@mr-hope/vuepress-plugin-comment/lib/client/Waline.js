        ...
        if (this.walineEnable)
            timeout = setTimeout(() => {
                ...
                void import(/* webpackChunkName: "waline" */ "@waline/client").then(({ default: Waline }) => {
                    this.waline = Waline(Object.assign(Object.assign({ el: "#waline-comment", lang: this.$lang === "zh-CN" ? "zh-CN" : "en-US", locale: walineLocales[this.$localePath || "/"], meta: walineConfig.meta || ["nick", "mail"], requiredMeta: walineConfig.requiredMeta || ["nick"], emoji: [
