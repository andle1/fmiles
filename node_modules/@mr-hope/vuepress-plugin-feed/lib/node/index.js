...
const feedPlugin = (options, context) => {
    if (!(0, options_1.checkOptions)(options))
        return { name: "feed" };
    const channelOptions = (0, options_1.getFeedChannelOption)(options, context);
    const output = (0, options_1.getOutput)(options.output);
    const feedLinks = (0, options_1.getFeedLinks)(options, output, context);
    const pages = [];
    return {
        name: "feed",
        /**
        ...
        ready() {
            (0, injectHead_1.injectLinkstoHead)(options, context);
        },
        async generated() {
