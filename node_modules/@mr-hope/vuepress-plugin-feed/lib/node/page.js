...
class FeedPage {
    ...
    /** real url */
    get link() {
        return (0, utils_1.resolveUrl)(this.options.hostname, this.context.base, this.$page.path);
    }
    get description() {
        ...
        if (this.$page.excerpt)
            return (0, utils_1.resolveHTML)(this.context.markdown.render(this.$page.excerpt).html);
        return undefined;
    }
    get author() {
        var _a, _b;
        ...
        return author === false
            ...
            : author
                ...
                : ((_a = this.options.channel) === null || _a === void 0 ? void 0 : _a.author)
                    ? [(_b = this.options.channel) === null || _b === void 0 ? void 0 : _b.author]
                    : [];
    }
    get category() {
    ...
    get content() {
        ...
        return (0, utils_1.resolveHTML)(html);
    }
    get image() {
        var _a;
        const { image } = this.frontmatter;
        if (image) {
            if ((0, utils_1.isAbsoluteUrl)(image))
                return (0, utils_1.resolveUrl)(this.options.hostname, this.context.base, image);
            if ((0, utils_1.isUrl)(image))
                return image;
        }
